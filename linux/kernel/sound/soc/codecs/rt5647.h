...
#define RT5647_PWR_MO				(0x1 << 7)
#define RT5647_PWR_MO_BIT			7
...
enum {
	RT5647_BP_EVENT = BIT(0), /* Button Press */
...
void rt5647_set_a2dp_to_spk_delay(struct snd_soc_codec *codec, bool enable);
