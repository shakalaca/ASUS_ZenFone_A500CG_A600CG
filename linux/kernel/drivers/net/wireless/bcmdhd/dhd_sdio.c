...
//+ 
//	SLPAUTO_ENAB(bus) always return FALSE because BCM43362 does not support SR, hence wd_timer never be release.
//	We reset wd_timer here for BCM43362

//					printk("@@@@@@@@@@@@@@stop wd timer for 43362!!");
					dhd_os_wd_timer(bus->dhd, 0);
