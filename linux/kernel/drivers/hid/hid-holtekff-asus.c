 ...
 *
 *  Copyright (c) 2011 Derek Wang <Derek_Wang@asus.com>
 */
...
#include "hid-ids.h"
#include <linux/hid-holtekff.h>//ASUS BSP Xe flash
#if 1

MODULE_LICENSE("GPL");
MODULE_AUTHOR("Derek Wang <Derek_Wang@asus.com>");
...
//        holtekff_send(holtekff, hid, charging_cmd);
    ...
    hid_info(hid, "Force feedback for Holtek On Line Grip based devices by Derek Wang <Derek_Wang@asus.com>\n");
