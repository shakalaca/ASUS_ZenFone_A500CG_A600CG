...
/*
 * This is for automatically switch dual sim or single sim.
 *
 */
static int sim_id_proc_show(struct seq_file *m, void *v) {
...
static ssize_t sim_id_proc_write(struct file *file, const char __user *buffer,
...
static const struct file_operations sim_id_proc_fops = {
        .owner = THIS_MODULE,
        .open = sim_id_proc_open,
        .read = seq_read,
        .write = sim_id_proc_write,
        .llseek = seq_lseek,
