...
#define CLV_GPIO_SDIO_0_CMD		50+96
#define CLV_GPIO_SDIO_0_DAT0		42+96
#define CLV_GPIO_SDIO_0_DAT1		43+96
#define CLV_GPIO_SDIO_0_DAT2		44+96
#define CLV_GPIO_SDIO_0_DAT3		45+96
...
static int clv_sd_setup(struct sdhci_pci_data *data)
{
	...
	intel_scu_ipc_iowrite8(addr, value & 0xC7);

        gpio_request(CLV_GPIO_SDIO_0_CMD, "sdio0_cmd");
    	gpio_request(CLV_GPIO_SDIO_0_DAT0, "sdio0_data");
    	gpio_request(CLV_GPIO_SDIO_0_DAT1, "sdio1_data");
    	gpio_request(CLV_GPIO_SDIO_0_DAT2, "sdio2_data");
    	gpio_request(CLV_GPIO_SDIO_0_DAT3, "sdio3_data");
    	lnw_gpio_set_alt(CLV_GPIO_SDIO_0_CMD, LNW_ALT_1);
    	lnw_gpio_set_alt(CLV_GPIO_SDIO_0_DAT0, LNW_ALT_1);
    	lnw_gpio_set_alt(CLV_GPIO_SDIO_0_DAT1, LNW_ALT_1);
    	lnw_gpio_set_alt(CLV_GPIO_SDIO_0_DAT2, LNW_ALT_1);
    	lnw_gpio_set_alt(CLV_GPIO_SDIO_0_DAT3, LNW_ALT_1);
    	gpio_direction_input(CLV_GPIO_SDIO_0_CMD);
    	gpio_direction_input(CLV_GPIO_SDIO_0_DAT0);
    	gpio_direction_input(CLV_GPIO_SDIO_0_DAT1);
    	gpio_direction_input(CLV_GPIO_SDIO_0_DAT2);
    	gpio_direction_input(CLV_GPIO_SDIO_0_DAT3);

    	gpio_free(CLV_GPIO_SDIO_0_CMD);
    	gpio_free(CLV_GPIO_SDIO_0_DAT0);
    	gpio_free(CLV_GPIO_SDIO_0_DAT1);
    	gpio_free(CLV_GPIO_SDIO_0_DAT2);
    	gpio_free(CLV_GPIO_SDIO_0_DAT3);
