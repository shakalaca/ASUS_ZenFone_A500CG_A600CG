/*
 * platform_t4k35_180.c: t4k35 platform data initilization file
 *
...
static int t4k35_180_platform_init(struct i2c_client *client)
{
	int ret;
...
static int t4k35_180_platform_deinit(void)
{
	regulator_put(vprog1_reg);
	regulator_put(vprog2_reg);
...
static int t4k35_180_csi_configure(struct v4l2_subdev *sd, int flag)
{
...
static struct camera_sensor_platform_data t4k35_180_sensor_platform_data = {
	.gpio_ctrl      = t4k35_180_gpio_ctrl,
	.flisclk_ctrl   = t4k35_180_flisclk_ctrl,
	.power_ctrl     = t4k35_180_power_ctrl,
	.csi_cfg        = t4k35_180_csi_configure,
	.platform_init = t4k35_180_platform_init,
	.platform_deinit = t4k35_180_platform_deinit,
};

void *t4k35_180_platform_data(void *info)
{
	camera_reset = -1;

	return &t4k35_180_sensor_platform_data;
}
