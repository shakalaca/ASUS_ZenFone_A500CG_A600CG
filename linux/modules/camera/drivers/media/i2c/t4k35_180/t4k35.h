...
static struct tsb_reg const t4k35_Full_3280x2464_20fps_2lane[] = {
	...
	{TSB_8BIT, 0x0342, 0x13},    // LINE_LENGTH_PCK[15:8](15fps);
	{TSB_8BIT, 0x0343, 0xA8},    // LINE_LENGTH_PCK[7:0];
	...
	{TSB_8BIT, 0x0820, 0x06},    // MSB_LBRATE[31:24](MIPI=796.8);
	{TSB_8BIT, 0x0821, 0x39},    // MSB_LBRATE[23:16];
...
static struct tsb_reg const t4k35_Full_3280x2464_6fps_2lane[] = {
	...
	{TSB_8BIT, 0x0821, 0x00},    // MSB_LBRATE[23:16];
	{TSB_8BIT, 0x0900, 0x00},    // -/-/-/-/-/-/H_BIN[1:0];
	{TSB_8BIT, 0x0901, 0x00},    // -/-/-/-/-/-/V_BIN_MODE[1:0];
	{TSB_8BIT, 0x0902, 0x00},    // -/-/-/-/-/-/BINNING_WEIGHTING[1:0];
	{TSB_8BIT, 0x32F7, 0x00},    // -/-/-/-/-/-/-/PP_DCROP_SW;
...
static struct tsb_reg const t4k35_Full_3280x1852_26fps_2lane[] = {
	...
	{TSB_8BIT, 0x0342, 0x18},    // LINE_LENGTH_PCK[15:8](15fps);
	{TSB_8BIT, 0x0343, 0xCC},    // LINE_LENGTH_PCK[7:0];
...
static struct tsb_reg const t4k35_Full_3280x1852_8fps_2lane[] = {
	...
	{TSB_8BIT, 0x0303, 0x06},    // -/-/-/-/VT_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x030B, 0x01},    // -/-/-/-/OP_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x0340, 0x16},    // FR_LENGTH_LINES[15:8];
	{TSB_8BIT, 0x0341, 0x08},    // FR_LENGTH_LINES[7:0];
	{TSB_8BIT, 0x0342, 0x10},    // LINE_LENGTH_PCK[15:8];
	{TSB_8BIT, 0x0343, 0xA0},    // LINE_LENGTH_PCK[7:0];
	{TSB_8BIT, 0x0346, 0x01},    // Y_ADDR_START[15:8];
	{TSB_8BIT, 0x0347, 0x30},    // Y_ADDR_START[7:0];
	{TSB_8BIT, 0x034A, 0x08},    // Y_ADDR_END[15:8];
	{TSB_8BIT, 0x034B, 0x6B},    // Y_ADDR_END[7:0];
...
static struct tsb_reg const t4k35_Bin_1632x1228_30fps_2lane[] = {
	...
	{TSB_8BIT, 0x0342, 0x13},    // LINE_LENGTH_PCK[15:8];
	{TSB_8BIT, 0x0343, 0x38},    // LINE_LENGTH_PCK[7:0];
	{TSB_8BIT, 0x0346, 0x00},    // Y_ADDR_START[15:8];
	{TSB_8BIT, 0x0347, 0x00},    // Y_ADDR_START[7:0];
	{TSB_8BIT, 0x034A, 0x09},    // Y_ADDR_END[15:8];
	{TSB_8BIT, 0x034B, 0x9F},    // Y_ADDR_END[7:0];
...
static struct tsb_reg const t4k35_Bin_1632x1228_30fps_2lane_sum[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x01},    // -/-/-/-/VT_PIX_CLK_DIV[3:0];
	{TSB_8BIT, 0x0303, 0x06},    // -/-/-/-/VT_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x030B, 0x01},    // -/-/-/-/OP_SYS_CLK_DIV[3:0];
...
static struct tsb_reg const t4k35_Bin_1616x916_30fps_2lane_sum[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0301, 0x01},    // -/-/-/-/VT_PIX_CLK_DIV[3:0];
	{TSB_8BIT, 0x0303, 0x06},    // -/-/-/-/VT_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x030B, 0x01},    // -/-/-/-/OP_SYS_CLK_DIV[3:0];
...
static struct tsb_reg const t4k35_FHD_1936x1096_30fps_2lane[] = {
	...
	{TSB_8BIT, 0x0821, 0x0C},    // MSB_LBRATE[23:16];
	{TSB_8BIT, 0x0900, 0x00},    // -/-/-/-/-/-/H_BIN[1:0];
	{TSB_8BIT, 0x0901, 0x00},    // -/-/-/-/-/-/V_BIN_MODE[1:0];
	{TSB_8BIT, 0x0902, 0x00},    // -/-/-/-/-/-/BINNING_WEIGHTING[1:0];
	{TSB_8BIT, 0x32F7, 0x01},    // -/-/-/-/-/-/-/PP_DCROP_SW;
...
static struct tsb_reg const t4k35_HD_1296x736_30fps_2lane[] = {
	...
	{TSB_8BIT, 0x0821, 0x1C},    // MSB_LBRATE[23:16];
	{TSB_8BIT, 0x0900, 0x01},    // -/-/-/-/-/-/H_BIN[1:0];
	{TSB_8BIT, 0x0901, 0x01},    // -/-/-/-/-/-/V_BIN_MODE[1:0];
	{TSB_8BIT, 0x0902, 0x00},    // -/-/-/-/-/-/BINNING_WEIGHTING[1:0];
	{TSB_8BIT, 0x32F7, 0x01},    // -/-/-/-/-/-/-/PP_DCROP_SW;
...
static struct tsb_reg const t4k35_Bin_656x496_30fps_2lane[] = {
	...
	{TSB_8BIT, 0x0301, 0x01},    // -/-/-/-/VT_PIX_CLK_DIV[3:0];
	{TSB_8BIT, 0x0303, 0x06},    // -/-/-/-/VT_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x030B, 0x05},    // -/-/-/-/OP_SYS_CLK_DIV[3:0];
	{TSB_8BIT, 0x0340, 0x05},    // FR_LENGTH_LINES[15:8];
	{TSB_8BIT, 0x0341, 0x98},    // FR_LENGTH_LINES[7:0];
	{TSB_8BIT, 0x0342, 0x11},    // LINE_LENGTH_PCK[15:8];
	{TSB_8BIT, 0x0343, 0x76},    // LINE_LENGTH_PCK[7:0];
	...
	{TSB_8BIT, 0x0821, 0x3E},    // MSB_LBRATE[23:16];
	{TSB_8BIT, 0x0900, 0x01},    // -/-/-/-/-/-/H_BIN[1:0];
	{TSB_8BIT, 0x0901, 0x01},    // -/-/-/-/-/-/V_BIN_MODE[1:0];
	{TSB_8BIT, 0x0902, 0x00},    // -/-/-/-/-/-/BINNING_WEIGHTING[1:0];
	{TSB_8BIT, 0x32F7, 0x01},    // -/-/-/-/-/-/-/PP_DCROP_SW;
...
static struct tsb_reg const t4k35_init_settings[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{TSB_8BIT, 0x0101, 0x03},    // -/-/-/-/-/-/IMAGE_ORIENT[1:0];
	...
	{TSB_8BIT, 0x0307, 0xA6},    // PLL_MULTIPLIER[7:0];
	{TSB_8BIT, 0x030B, 0x01},    // -/-/-/-/OP_SYS_CLK_DIV[3:0];
...
struct tsb_resolution t4k35_res_preview[] = {
	...
	},
    {
        ...
        .fps_options = {
            {
                 .fps = 15,			// Trial 1127b
                 .pixels_per_line = 0x18CC,	// Trial 1127b
    ...
    },
    {
        ...
        .fps_options = {
            {
                 .fps = 15,			// Trial 1127a
                 .pixels_per_line = 0x13A8,	// Trial 1127a
...
struct tsb_resolution t4k35_res_still[] = {
	...
	{
		.desc = "STILL_Bin_1616x916_30fps_2lane_sum",
		.regs = t4k35_Bin_1616x916_30fps_2lane_sum,
		.width = 1616,
		.height = 916,
		.bin_factor_x = 2,
		.bin_factor_y = 2,
	...
	{
		.desc = "STILL_Bin_1632x1228_30fps_2lane_sum",
		.regs = t4k35_Bin_1632x1228_30fps_2lane_sum,
		.width = 1632,
		.height = 1228,
		.bin_factor_x = 2,
		.bin_factor_y = 2,
	...
	},
	{
		...
		.fps_options = {
			{
				 .fps = 8,
				 .pixels_per_line = 0x10A0,
				 .lines_per_frame = 0x1608,
			},
			{
			}
		},
...
struct tsb_resolution t4k35_res_video[] = {
        ...
        {
                .desc = "VIDEO_2M_1632x1228_30fps_2lane",	// Trial 1127c
                .regs = t4k35_Bin_1632x1228_30fps_2lane,	// Trial 1127c
                .width = 1632,		// Trial 1127c
                .height = 1228,		// Trial 1127c
                .bin_factor_x = 2,
                .bin_factor_y = 2,
                .used = 0,
                .skip_frames = 3,
                .fps_options = {
                        {
                                 .fps = 30,
                                 .pixels_per_line = 0x1338,	// Trial 1127b
                                 .lines_per_frame = 0x070A,
                        },
                        {
                        }
