...
#define HM2056_FOCAL_LENGTH_NUM	293	/*2.93mm*/
#define HM2056_FOCAL_LENGTH_DEM	100
#define HM2056_F_NUMBER_DEFAULT_NUM	28
 ...
 */
#define HM2056_FOCAL_LENGTH_DEFAULT 0x1250064

/*
 * current f-number bits definition:
 * bits 31-16: numerator, bits 15-0: denominator
 */
#define HM2056_F_NUMBER_DEFAULT 0x1c000a
 ...
 */
#define HM2056_F_NUMBER_RANGE 0x1c0a1c0a
...
static struct hm2056_reg const hm2056_stream_off[] = {
	...
	{HM2056_TOK_DELAY, 0, 100},     // Delay 100 ms
	{HM2056_TOK_TERM, 0, 0}
};
...
static struct hm2056_reg const hm2056_uxga_8fps[] = {
	{HM2056_8BIT, 0x0024, 0x00},
	{HM2056_8BIT, 0x0006, 0x00},
	{HM2056_8BIT, 0x000D, 0x00},
	{HM2056_8BIT, 0x000E, 0x00},
	{HM2056_8BIT, 0x0010, 0x04},
	{HM2056_8BIT, 0x0011, 0x4C},
	{HM2056_8BIT, 0x0012, 0x04},
	{HM2056_8BIT, 0x0013, 0x00},
	{HM2056_8BIT, 0x002A, 0x2F},
	{HM2056_8BIT, 0x0071, 0xAB},
...
//1620x912
static struct hm2056_reg const hm2056_hdp_19fps[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    ...
    {HM2056_8BIT, 0x0024, 0x40},
	{HM2056_TOK_DELAY, 0, 60}, // Delay longer than 1 frame time ~52ms
    {HM2056_TOK_TERM, 0, 0}
};

//1620x912
static struct hm2056_reg const hm2056_hdp_10fps[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x14},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x03},
    {HM2056_8BIT, 0x0011, 0xDC},
    {HM2056_8BIT, 0x0012, 0x04},
    {HM2056_8BIT, 0x0013, 0x00},
    {HM2056_8BIT, 0x002A, 0x2F},
    {HM2056_8BIT, 0x0071, 0xAB},
...
//1392x780
static struct hm2056_reg const hm2056_1392x780_28fps[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x10},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x00},
    {HM2056_8BIT, 0x0011, 0x84},
    {HM2056_8BIT, 0x0012, 0x04},
    {HM2056_8BIT, 0x0013, 0x00},
    {HM2056_8BIT, 0x002A, 0x2F},
    {HM2056_8BIT, 0x0071, 0xAB},
    ...
    {HM2056_8BIT, 0x05EB, 0x03},
    {HM2056_8BIT, 0x0024, 0x40},
	{HM2056_TOK_DELAY, 0, 40}, // Delay longer than 1 frame time ~35ms
    {HM2056_TOK_TERM, 0, 0}
};

//1296x812
static struct hm2056_reg const hm2056_1296x812_28fps[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x04},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x00},
    {HM2056_8BIT, 0x0011, 0x8d},
    {HM2056_8BIT, 0x0012, 0x08},
    {HM2056_8BIT, 0x0013, 0x00},
    {HM2056_8BIT, 0x002A, 0x2F},
 ...
 * 1296x732
 */
static struct hm2056_reg const hm2056_720p_27fps[] = {
	{HM2056_8BIT, 0x0024, 0x00},
...
static struct hm2056_raw_res_struct hm2056_raw_res_video[] = {
	...
	//{
	    ...
	    //.vertical_end = 811,
	    //.pixel_clk = 39000000,
	    //.line_length_pck = 1599,
	    //.frame_length_lines = 953,
	    //.bin_factor_x = 1,
	    //.bin_factor_y = 1,
	    //.bin_mode = 0,
	//},
/*
	{
	    ...
	    .vertical_end = 779,
	    .pixel_clk = 39000000,
	    .line_length_pck = 1711,
	    .frame_length_lines = 912,
	    .bin_factor_x = 1,
	    .bin_factor_y = 1,
	    .bin_mode = 0,
	},
