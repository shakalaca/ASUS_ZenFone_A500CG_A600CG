...
#define TSB_FOCAL_LENGTH_NUM	378	/*3.78mm*/
#define TSB_FOCAL_LENGTH_DEM	100
#define TSB_F_NUMBER_DEFAULT_NUM	20
...
struct max_res tsb_max_res = {
	//[T4K37_ID] = {
		.res_max_width = T4K37_RES_WIDTH_MAX,
		.res_max_height = T4K37_RES_HEIGHT_MAX,
	//},
	//[T4K35_ID] = {
...
struct tsb_settings tsb_set = {
	//[T4K37_MERRFLD] = {
		.init_settings = t4k37_init_settings,
		.res_preview = t4k37_res_preview,
		.res_still = t4k37_res_still,
		.res_video = t4k37_res_video,
		.n_res_preview = ARRAY_SIZE(t4k37_res_preview),
		.n_res_still = ARRAY_SIZE(t4k37_res_still),
		.n_res_video = ARRAY_SIZE(t4k37_res_video),
	//},
//	[T4K35_MERRFLD] = {
